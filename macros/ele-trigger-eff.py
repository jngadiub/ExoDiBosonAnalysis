...
fname1 = '../../AnalysisOutput/triggers25ns/SingleElectron.Run2015D.%s.root'%fsuf      
fname2 = '../../AnalysisOutput/triggers25ns/SingleElectron.Run2015C.%s.root'%fsuf
...
nu = hnum1.Integral(hnum1.GetXaxis().FindBin(120.),hnum1.GetNbinsX())
de = hden1.Integral(hden1.GetXaxis().FindBin(120.),hden1.GetNbinsX())
...
nu = hnum2.Integral(hnum2.GetXaxis().FindBin(120.),hnum2.GetNbinsX())
de = hden2.Integral(hden2.GetXaxis().FindBin(120.),hden2.GetNbinsX())
...
pt.SetBorderSize(0)
pt.SetFillStyle(0)
text = pt.AddText("HLT_Ele105_CaloIdVT_GsfTrkIdT")
text.SetTextFont(62)
text = pt.AddText("HEEP ID")
text.SetTextFont(42)
if suffix == "PT": text = pt.AddText("0 < |#eta| < 2.5")
if suffix == "Eta": text = pt.AddText("p_{T} > 120 GeV")
text.SetTextFont(42)
...
if suffix == "PT":
   mg.GetXaxis().SetTitle("Electron p_{T} [GeV]")
